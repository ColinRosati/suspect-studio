...
var item = arc[Math.floor(Math.random()*arc.length)];
	...
	var item = ard[Math.floor(Math.random()*ard.length)];
	var sentenceArd = []
	...
	document.getElementById('headline3').innerHTML = sentenceArd.join(" ");

}


setInterval(getHeadline,3000);
getHeadline();